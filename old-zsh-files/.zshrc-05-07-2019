...
# POWERLEVEL9K_VCS_PROMPT_PREFIX='('
# POWERLEVEL9K_VCS_PROMPT='('
# POWERLEVEL9K_VCS_PROMPT_SUFFIX='('
# POWERLEVEL9K_VCS_PROMPT='('



# ZSH_THEME_GIT_PROMPT_PREFIX="%{$fg_bold[blue]%}git:(%{$fg[red]%}"
# POWERLEVEL9K_GIT_PROMPT_PREFIX="%{$fg_bold[blue]%}git:(%{$fg[red]%}"
...
# POWERLEVEL9K_TIME_ICON="echo $set_time_icon"
# POWERLEVEL9K_TIME_ICON="$(set_time_icon)"
# POWERLEVEL9K_TIME_ICON=""
# POWERLEVEL9K_TIME_FORMAT="${echo $(set_time_icon)}%D{%H:%M:}"
# POWERLEVEL9K_CUSTOM_TIME="echo $(set_time_icon) $( date +%H:%M:%S)"
# POWERLEVEL9K_CUSTOM_TIME="echo $( date +%H:%M:%S)"
...
# POWERLEVEL9K_ETC_FOREGROUND='-1'
# POWERLEVEL9K_ETC_ICON_FOREGROUND='-1'
